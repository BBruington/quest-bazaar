...
export default function CampaignChat(props: { campaignProps: Campaign }) {
  ...
  return (
    <>
      {loadingChat ? (
        <div className="flex h-5/6 w-4/6 flex-col self-center rounded-md bg-accent-foreground p-2 lg:w-5/6">
        ...
        <div className="flex h-5/6 w-4/6 flex-col self-center rounded-md bg-accent-foreground p-2 lg:w-4/6">
          <div className="mt-auto">
