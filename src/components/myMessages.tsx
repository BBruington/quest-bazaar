      ...
      <div className="w-1/6 mx-2">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger>Notifications <span className={`${pendingFR && pendingFR.length > 0 ?'text-white text-xs bg-red-600 items-center rounded-full w-4 h-4' : ''}`}>{pendingFR && pendingFR.length > 0 ? pendingFR.length : null}</span></AccordionTrigger>
            <AccordionContent>
